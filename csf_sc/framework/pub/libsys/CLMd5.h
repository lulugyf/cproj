...
#define PROTOTYPES 1				/* Assume prototypes */
	...
	//typedef ub2 UINT2;				/* Fix for MySQL / Alpha */

	/* ub4 defines a four byte word */
	//typedef ub4 ub4;				/* Fix for MySQL / Alpha */
...
#define PROTO_LIST(list) ()
	...
	/* MD5 context. */
	typedef struct {
		ub4 state[4];                                   /* state (ABCD) */
		ub4 count[2];        /* number of bits, modulo 2^64 (lsb first) */
