...
#define SHA1CircularShift(bits,word) \
	...
	*/
	...
	int sha1_result(SHA1_CONTEXT *context,
		ub1 Message_Digest[SHA1_HASH_SIZE])
	{
		int i;
		...
		for (i = 0; i < SHA1_HASH_SIZE; i++)
			Message_Digest[i] = (sb1)((context->Intermediate_Hash[i>>2] >> 8
			* ( 3 - ( i & 0x03 ) )));
		return SHA_SUCCESS;
	}
	...
	*/
	...
	int sha1_input(SHA1_CONTEXT *context, const ub1 *message_array,
		unsigned length)
	{
		if (!length)
			return SHA_SUCCESS;
	...
	*/
	...
	{
		int		t;		   /* Loop counter		  */
		ub4	temp;		   /* Temporary word value	  */
		ub4	W[80];		   /* Word sequence		  */
		ub4	A, B, C, D, E;	   /* Word buffers		  */
		int index;
	...
	void SHA1PadMessage(SHA1_CONTEXT *context)
	{
		...
		*/
		...
		if (i > 55)
		{
			...
			memset((char*) &context->Message_Block[i],
				0,sizeof(context->Message_Block[0])*(64-i));
		...
		*/
		...
		context->Message_Block[56] = (sb1) (context->Length >> 56);
		context->Message_Block[57] = (sb1) (context->Length >> 48);
		context->Message_Block[58] = (sb1) (context->Length >> 40);
		context->Message_Block[59] = (sb1) (context->Length >> 32);
		context->Message_Block[60] = (sb1) (context->Length >> 24);
		context->Message_Block[61] = (sb1) (context->Length >> 16);
		context->Message_Block[62] = (sb1) (context->Length >> 8);
		context->Message_Block[63] = (sb1) (context->Length);
